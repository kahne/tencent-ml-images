...
def get_oix_image_list():
    ...
    # image_root = '/scratch/changhan/oix'
    output_path = '/private/home/changhan/projects/image_classification_fairness/data/oix_img_list.txt'

    part_dir_pattern = 'crowdsource_images-0000{}-of-00010'
    img_id_to_part_id = {}
    for i in tqdm(range(10)):
        for p in tqdm(os.listdir(os.path.join(image_root, part_dir_pattern.format(i)))):
            if p.endswith('.jpg'):
        ...
        with open(output_path, 'w') as f_out:
            for r in tqdm(reader):
                ...
                if img_id not in img_id_to_part_id:
                    ...
                    continue
                path = os.path.join(image_root, part_dir_pattern.format(img_id_to_part_id[img_id]), img_id + '.jpg')
                f_out.write(path + '\n')
